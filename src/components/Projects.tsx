...
const projects: ProjectItem[] = [
  ...
  },
  {
    ...
    description:
      "A powerful browser-based 3D viewer and configurator. Enables businesses to showcase products in 3D with real-time customization, animation support, and seamless website integration.",
  ...
  },
  {
    ...
    description:
      "An immersive 360-degree 3D bike configurator. Users can customize colors, accessories, and view the bike from every angle in real-time.",
